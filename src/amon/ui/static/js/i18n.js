const dictionary = {
  ...
  "action.deleteContext.confirmTitle": "確認刪除上下文",
  "a11y.sidebar": "主要導覽",
  "a11y.topbar": "工作列",
  ...
  "tooltip.daemonIdle": "尚未建立串流，送出任務後會開始連線",
  "toast.default": "已完成操作",
  "view.context.empty": "尚未載入上下文，請先輸入專案背景。",
  "view.context.create": "新增上下文",
  "toast.context.selectProject": "請先選擇專案後再儲存上下文。",
  "toast.context.saved": "上下文已儲存。",
  "toast.context.saveFailed": "儲存失敗：{message}",
  "modal.context.clearTitle": "確認清空上下文",
  "modal.context.clearDescription.project": "確定要清空專案上下文嗎？",
  "modal.context.clearDescription.chat": "確定要清空本次對話上下文嗎？",
  "modal.context.clearConfirm": "清空",
  "modal.context.clearCancel": "取消",
  "toast.context.cleared": "上下文已清空。",
  "toast.context.clearFailed": "清空失敗：{message}",
  "toast.context.loadFailed": "載入上下文失敗：{message}",
  ...
  "timeline.waitingContextRefresh": "等待下一次上下文刷新",
